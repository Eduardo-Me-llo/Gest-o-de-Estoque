...
def validar_e_extrair_email(email):
    padrao = r'^([a-zA-ZÀ-ÿ]+)\.([a-zA-ZÀ-ÿ]+)@bravantes\.com\.br$'
...
class EstoqueApp(tb.Window):
    def __init__(self):
        ...
        self.title("Gestão de Estoque bravantes")
    ...
    def _registrar_usuario(self, janela):
        ...
        if not valido:
            messagebox.showerror("Erro", 
                "Email inválido! Formato correto: nome.sobrenome@bravantes.com.br\n"
                "Exemplo: joao.silva@bravantes.com.br")
            return
